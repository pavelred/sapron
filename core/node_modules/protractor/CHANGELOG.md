...
- ([dd2ccbb](https://github.com/angular/protractor/commit/dd2ccbb1b73b7c90647837cd1c4f6b16b3f6b0ac))
  ...
  New option `sauceSeleniumUseHttp` available in `protractor.conf.ts`
...
- The protocol for a Sauce Labs selenium relay (sauceSeleniumAddress in protractor.conf.ts)
...
- ([0b93003](https://github.com/angular/protractor/commit/0b930035905d1868225667de358222e51394f3ac))
  ...
  feature, either: 1) specify jasmineNodeOpts.grep in your conf.ts file
   or 2) via commandline like "protractor conf.ts --grep='pattern to match'"
...
- ([74761e8](https://github.com/angular/protractor/commit/74761e8b25395dd78e1c301ee23a7730fef36db9))
  feat(cli): use protractor.conf.ts as a default config file if none is passed
...
protractor debug conf.ts works.
